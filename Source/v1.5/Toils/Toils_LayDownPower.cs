        ...
        public static Toil LayDown(TargetIndex chargingBuilding, bool hasBed, bool lookForOtherJobs = true, bool canSleep = true)
        {
            ...
            layDown.initAction = delegate
            {
                ...
                if (hasBed)
                {
                    ...
                    {
                        Log.Error("[ABF] Can't start LayDown toil because pawn is not in the bed. pawn=" + actor);
            ...
            layDown.tickAction = delegate
            {
                ...
                // Pawns that are using this bed for some other purpose (like coherence) will not abort either, as charging is not their primary job here.
