    ...
    public class IngestionOutcomeDoer_SplitEffects : IngestionOutcomeDoer
    {
        ...
        protected override void DoIngestionOutcomeSpecial(Pawn pawn, Thing ingested, int ingestedCount)
        {
            ...
            if (!ABF_Utils.IsArtificial(pawn))
            {
                ...
                AddictionUtility.ModifyChemicalEffectForToleranceAndBodySize_NewTemp(pawn, organicTolerance, ref severity, useOrganicGeneToleranceFactors, divideByBodySize);
            ...
            else
            {
                ...
                AddictionUtility.ModifyChemicalEffectForToleranceAndBodySize_NewTemp(pawn, artificialTolerance, ref severity, false, divideByBodySize);
                hediff.Severity = severity;
                pawn.health.AddHediff(hediff);
            }
        }
